...
module.exports = class Utils {
    ...
    async loadCommands() {
        readdir("./src/resources/commands", (err, files) => {
            if (err) return this.client.loggers.error(`[ERROR] | Ocorreu um erro com o Structure Commands!\n${err}`)
                ...
                readdir(`./src/resources/commands/${dir}/`, (err, commands) => {
                    ...
                    for (const com of commands) {
                        try {
                            ...
                            //this.client.loggers.log(`[SUCESS] | Structure Commands, foi carregado com sucesso sem erros!`)
	...
	async loadEvents() {
        ...
        for (const dir of eventFolder) {
            ...
            for (const file of folderFiles) {
                ...
                //this.client.loggers.log(`[SUCESS] | Structure Events, foi carregado com sucesso sem erros!`)
